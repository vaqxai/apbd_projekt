...
namespace apbd_projekt.Server.Data.Migrations
{
    ...
    [Migration("20220623224921_stock and search cache")]
    partial class stockandsearchcache
    {
            ...
            modelBuilder.Entity("apbd_projekt.Server.Models.CachedStock", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CachedStockId"), 1L, 1);
                    ...
                    b.HasKey("CachedStockId");

                    b.HasIndex("StockId");

                    b.ToTable("CachedStocks");
                });
